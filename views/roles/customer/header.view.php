            ...
            <div class="full-box nav-lateral-content">
                ...
                <nav class="full-box nav-lateral-menu">
                    <ul>
                        <li>
                            <a href="?c=Dashboard">
                                <i class="fab fa-dashcube fa-fw"></i> &nbsp; <?php echo ucfirst($session); ?>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#">
                                        <i class="fas fa-plus fa-fw"></i> &nbsp; Registrar Compra
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Consultar Compras
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
