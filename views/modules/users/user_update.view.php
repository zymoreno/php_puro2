            ...
            <div class="container-fluid">
                <form action="" method="POST" class="form-neon" autocomplete="off">
                    <fieldset>
                        <legend>
                            <i class="far fa-address-card"></i> &nbsp; Actualizar Información personal
                        </legend>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <input
                                    ...
                                    name="user_code"
                                    id="user_code"
                                    value="<?php echo $user->getUserCode(); ?>"
                                >
                                        ...
                                        <select class="form-control" name="rol_code">
                                            <?php foreach ($roles as $rol) : ?>
                                                <?php if ($rol->getRolCode() == $user->getRolCode()) : ?>
                                                    <option selected value="<?php echo $rol->getRolCode(); ?>">
                                                        <?php echo $rol->getRolName(); ?>
                                                    </option>
                                                <?php else : ?>
                                                    <option value="<?php echo $rol->getRolCode(); ?>">
                                                        <?php echo $rol->getRolName(); ?>
                                                    </option>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
