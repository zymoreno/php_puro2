            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="?c=Users&a=userRead">
                        ...
                        <tbody>
                            <?php foreach ($users as $user) : ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a
                                            href="?c=Users&a=userUpdate&idUser=<?php echo $user->getUserCode(); ?>"
                                    ...
                                    <td>
                                        <a
                                            href="?c=Users&a=userDelete&idUser=<?php echo $user->getUserCode(); ?>"
